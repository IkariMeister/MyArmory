...
import com.jcgseco.myarmory.uicomponents.extensions.setDelayOnClickListener
...
class ToolbarView @JvmOverloads constructor(
    ...
    fun setLeftOnClickButton(clickFunction: () -> Unit) {
        binding.leftToolbarButton.setDelayOnClickListener { clickFunction() }
    }

    fun setRightOnClickButton(clickFunction: () -> Unit) {
        binding.rightToolbarButton.setDelayOnClickListener { clickFunction() }
    }
